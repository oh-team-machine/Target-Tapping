...
namespace GameLibrary.UI
{
    ...
    public class Button
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if (bMouseDownInside)
            {
                spriteBatch.Draw(icon, new Vector2(Rect.X + Rect.Width / 2, Rect.Y + Rect.Height / 2), null, Color.Gray, 0.0f, new Vector2(Rect.Width / 2f, Rect.Height / 2f), 0.8f, SpriteEffects.None, 0);
            }
            else
