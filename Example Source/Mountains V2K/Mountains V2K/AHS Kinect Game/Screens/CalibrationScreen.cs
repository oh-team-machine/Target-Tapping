...
namespace AHS_Kinect_Game.Screens
{
    class CalibrationScreen : GameLibrary.Screen
    {
        ...
        public override void LoadContent()
        {
            ...
            float xOffset = ScreenManager.GraphicsDevice.Viewport.Width - textUR.Width;
            float yOffset = ScreenManager.GraphicsDevice.Viewport.Height - textUR.Height;

            float middle = (ScreenManager.GraphicsDevice.Viewport.Width / 2.0f) - (textUR.Width / 2.0f);
